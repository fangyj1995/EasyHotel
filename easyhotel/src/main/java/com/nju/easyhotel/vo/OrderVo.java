...
public class OrderVo {
	...
	public OrderVo(String id, String memberId, String hotelId, Date startDate, Date endDate, Date checkInTime,
	...
	public String toString() {
		return "OrderVo [id=" + id + ", memberId=" + memberId + ", hotelId=" + hotelId + ", startDate=" + startDate
